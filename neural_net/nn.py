...
class NeuralNet:
    ...
    def __init__(self, nunits):
        ...
        wdims = []
        lenweights = 0
        print("_n Layers {}".format(self._nLayers))
        for i in range(self._nLayers):
            nwr = nunits[i] + 1
            print(" i {} nwr {}".format(i,nwr))
            nwc = nunits[i+1]
            print(" i {} nwc {}".format(i,nwc))
            wdims.append((nwr, nwc))
            print("wdims shape {}:".format(wdims))
            lenweights = lenweights + nwr * nwc
            print("lenweights {}".format(lenweights))
        ...
        for i in range(self._nLayers):
            ...
            print(" i {} _W {}".format(i,self._W))
            self._W[i].resize(wdims[i])
            print(" i {} _W[i] {}".format(i,self._W[i].shape))
            start = end
